...
, to make this repo self contained, loose all the CausalBench challenge specific wrapper code, and get PSGRN as a standalone inference method. I've made some changes, just for information. //AB
"""
