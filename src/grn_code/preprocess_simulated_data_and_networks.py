...
def main(output_path, preprocessing_options):
    ...
    data_raw = anton_util.unpickle_object(output_path / 'simulations.pkl')
    datasets = data_raw
    ...
    datasets = update_datasets(
            ...
            function_options = preprocessing_options['shuffle'],
            )
    ...
    datasets = update_datasets(
            ...
            function_options = preprocessing_options['cell normalised'],
    ...
    datasets = update_datasets(
            ...
            function_options = preprocessing_options['pseudo_bulk'],
    ...
    datasets = update_datasets(
            datasets = datasets,
            update_function = functions.normalise,
            function_options = preprocessing_options['read normalised'],
            function_kwargs = function_kwargs,
            )
    ...
    datasets = update_datasets(
        ...
        function_options = preprocessing_options['transform 1'],
        function_kwargs = function_kwargs,
        )
    ...
    datasets = update_datasets(
        datasets = datasets,
        update_function = functions.transform,
        function_options = preprocessing_options['transform 2'],
        function_kwargs = function_kwargs,
        )
    ...
    datasets = update_datasets(
        ...
        function_options = preprocessing_options['compute differences'],
        )
    ...
    outfile = Path(output_path / 'preprocessed_data.pkl')
